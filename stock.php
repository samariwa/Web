<?php
 ...
 ?> 
    ...
    <div class="col-md-3">
      <a href="shelf_life.php" class="btn btn-info btn-md active offset-1" role="button" aria-pressed="true">Stock Shelf Life</a>
      </div>
      <div class="col-md-2">
      <a href="damaged.php" class="btn btn-secondary btn-md active" role="button" aria-pressed="true" >Damaged Stock</a>
      </div>
      <div class="col-md-3">
      <a href="valuation.php" class="btn btn-warning btn-md active offset-3" role="button" aria-pressed="true" >Stock Valuation</a>
      </div>
      <div class="col-md-2">
